OC.L10N.register(
    ...
    "User limit reached": "Достигнут лимит пользователей",
    "The limit of users has been reached, to increase the number of users, select an advanced plan.": "Достигнут лимит пользователей, чтобы увеличить количество пользователей, выберите расширенный тариф."
},
